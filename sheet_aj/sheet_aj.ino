...
#define DHTPIN 17 // !!!!!! Pin of DHT !!!!!!
#define DHTTYPE DHT22  // DHT 22  (AM2302), AM2321

//----------------------------------------SSID dan Password wifi mu gan.
const char* ssid = "Topsan iPhone";       //--> Nama Wifi / SSID.
...
String GAS_ID = "AKfycbwJ99RxfJACX2itcecTDzaeZRPnBdPM5jvaf8YzVCDw-WAvFo-RR16yFcOU5nMBu8Jkrg";  //--> spreadsheet script ID
